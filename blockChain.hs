...
ejecutarTest = hspec $ do
  ...
  describe "Pruebas sobre las transiciones" $ do
    ...
    it "pepe le da 7 unidades a Lucho y despues pepe deposita 5 monedas, deberia quedar con 9 monedas" $   (billetera.pepeLeDa7UnidadesALucho.pepeDeposita5Monedas) pepe `shouldBe` 8 
